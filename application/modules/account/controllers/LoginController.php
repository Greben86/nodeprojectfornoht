...
//        return $localConfig->api->host.'/customers/checkpass?in='.urlencode($this->username).'&pass='.md5($this->password);
        return 'http://194.67.215.76:8080/shop/customers/checkpass?login=' . urlencode($this->username) . '&pass=' . md5($this->password);
    }
    ...
    public function init() {
        ...
        $username->setOptions(array('size' => '35'))
                ...
                ->addValidator('NotEmpty', true, array(
                    'messages' => array(
                        Zend_Validate_NotEmpty::IS_EMPTY => 'Email не может быть пустым'
            )))
